...
* git clone [https://github.com/arianasadeghi/Modular-RPG-Game.git](https://github.com/arianasadeghi/Modular-RPG-Game.git)

2. **Open the project in IntelliJ IDEA.**

3. **Ensure the json-20240303.jar** (located in the lib/ directory) is added to your project structure (File -> Project Structure -> Modules -> Dependencies).

4. **Run the LoginPage.java file** to start the game using the interface.
