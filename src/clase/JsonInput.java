...
public class JsonInput {
    public static ArrayList<Account> deserializeAccounts() {
        String accountPath = "C:\\Users\\Aryana\\Desktop\\teme_POO\\Tema1\\accounts.json";
        try {
            ...
            for (int i=0; i < accountsArray.length(); i++) {
                ...
                try {
                    ...
                    for (int j = 0; j < charactersListJson.length(); j++) {
                        ...
                        if (profession.equals("Warrior"))
                            newCharacter = FactoryPattern.createCharacter(cname, profession, experience, lvl);
                ...
                Account.Information information = new Account.Information.Builder().setCredentials(credentials).setFavoriteGames(favoriteGames).setName(name).setCountry(country).build();
